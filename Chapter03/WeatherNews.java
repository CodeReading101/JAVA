...
// 소스파일 - https://github.com/CodeReading101/JAVA/blob/main/Chapter03/WeatherNews.java
...
public class WeatherNews
{
	public static void main( String[] args ) {
		...
		// 주요 날씨 내용을 입력
		System.out.print( "오늘의 기상 특보는 무엇인가요: " );
		String weatherReport = scan.next();
		System.out.print( "오늘의 주의 사항은 무엇인가요: " );
		...
		System.out.print( month + "월 " + day + "일 " + week + "요일 오늘의 날씨입니다. " );
		System.out.print( "주요 지역의 아침 최저기온은 서울 " + lowSeoul + "도, 춘천 " + lowChuncheon + "도, 대전 " + lowDaejeon + "도, 광주 " + lowGwangju + "도, 부산 " + lowBusan + "도, 제주 " + lowJeju + "도입니다. " );
		System.out.print( "낮 최고기온은 서울 " + highSeoul + "도, 춘천 " + highChuncheon + "도, 대전 " + highDaejeon + "도, 광주 " + highGwangju + "도, 부산 " + highBusan + "도, 제주 " + highJeju + "도입니다. " );
		System.out.println( weatherReport + "가 발효 중인 지역에서는 " + precaution + " 운전에 주의해 주시기 바랍니다. " );
		scan.close();
	}
}
