...
// 소스파일 - https://github.com/CodeReading101/JAVA/blob/main/Chapter03/FoodOrder.java
...
public class FoodOrder
{
	public static void main( String[] args ) {
		...
		// 주문 내역 확인
		System.out.println( "주메뉴는 " + mainDish + ", 소스는 " + sauce + ", 음료는 " + drink + "를 선택하셨습니다. " );
