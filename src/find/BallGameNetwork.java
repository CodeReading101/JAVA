...
// 소스파일 - https://github.com/CodeReading101/JAVA/blob/main/src/find/BallGameNetwork.java
 ...
 * @see     net.Network()
 */
public class BallGameNetwork extends BallGamePanel implements Runnable
{
	/**
	 * 네트워크
	 */
	 ...
	 * 구슬찾기 프로그램의 네트워크 초기화
	 */
	public BallGameNetwork( String imgPath )
	{
		super( imgPath );
	 ...
	 */
	public BallGameNetwork( String imgPath, String serverIP )
	{
		this( imgPath );
